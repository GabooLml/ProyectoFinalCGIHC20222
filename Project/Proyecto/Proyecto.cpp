...
//PARA LA IMPLEMENTACI�N DE SONIDO
#include <irrKlang.h>
...
//Variables para animaci�n del tiranosaurio
float movPiernaRT;
float movPiernaLT;
float movOffsetT;
float rotColaT;
...
//VARIABLES PARA EJECUCI�N HOMOGENEA EN CUALQUIER EQUIPO
...
int main()
{
	...
	//Nuestras im�genes de atr�s y delante (texturas) est�n invertidas con respecto a la creaci�n del skybox
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Animaci�n de la cola del tiranosaurio
		...
		////////////////////////////////////// GENERACI�N DE LOS ELEMENTOS DEL ESCENARIO ///////////////////
		////////////////// SUELO, POSTES, �RBOLES, ISLAS Y HELIPUERTO ////////////////////////////
